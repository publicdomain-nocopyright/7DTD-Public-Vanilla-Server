def get_latest_game_server_log_filepath(log_directory = None):
    ...
    if log_directory == "DEFAULT_LOG_DIRECTORY":
    ...
    import os; 
    if log_directory is DEFAULT_LOG_DIRECTORY:
        if os.path.exists(RELATIVE_LOG_DIRECTORY): 
            log_directory = RELATIVE_LOG_DIRECTORY
...
if __name__ == "__main__":
    get_latest_game_server_log_filepath("DEFAULT_LOG_DIRECTORY")